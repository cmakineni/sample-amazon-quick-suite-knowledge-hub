...
class AgentCoreGatewayStack(NestedStack):
    def __init__(self, scope: Construct, construct_id: str, 
                 actuarial_lambda_arn: str, data_query_lambda_arn: str, **kwargs) -> None:
    ...
    def _get_gateway_lambda_code(self):
        ...
        actuarial_tools_path = os.path.join(os.path.dirname(__file__), '..', 'tools', 'agentcore_tools.json')
        with open(actuarial_tools_path, 'r', encoding="utf-8") as f:
            actuarial_tools_json = json.dumps(json.load(f))
        
        # Load data query tools  
        data_query_tools_path = os.path.join(os.path.dirname(__file__), '..', 'tools', 'data_query_tools.json')
        with open(data_query_tools_path, 'r', encoding="utf-8") as f:
        ...
        lambda_code = lambda_code.replace('ACTUARIAL_TOOLS_PLACEHOLDER', actuarial_tools_json)
        lambda_code = lambda_code.replace('DATA_QUERY_TOOLS_PLACEHOLDER', data_query_tools_json)
