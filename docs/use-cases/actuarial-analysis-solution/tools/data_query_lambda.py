...
def list_tables() -> Dict[str, Any]:
    ...
    try:
        ...
        for table in response.get('TableList', []):
            tables.append({
                'name': table['Name'],
                'columns': [col['Name'] for col in table.get('StorageDescriptor', {}).get('Columns', [])]
            })
...
def run_query(query: str, natural_language_description: str = "") -> Dict[str, Any]:
    ...
    try:
        ...
        athena_output_location = os.environ.get('ATHENA_OUTPUT_LOCATION', 's3://actuarial-athena-results-us-east-1/query-results/')
        ...
        response = athena.start_query_execution(
            ...
            QueryExecutionContext={'Database': os.environ.get('ATHENA_DATABASE', 'claims_db')},
