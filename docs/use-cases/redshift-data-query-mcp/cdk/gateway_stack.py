...
class AgentCoreGatewayStack(NestedStack):
    def __init__(self, scope: Construct, construct_id: str, 
                 redshift_lambda_arn: str, **kwargs) -> None:
        ...
        gateway_creator_lambda = lambda_.Function(
            ...
            memory_size=512,
            environment={
                "REDSHIFT_LAMBDA_ARN": redshift_lambda_arn
            },
    ...
    def _get_gateway_lambda_code(self):
        ...
        # Load Redshift tools
        redshift_tools_path = os.path.join(os.path.dirname(__file__), '..', 'tools', 'redshift_agentcore_tools.json')
        with open(redshift_tools_path, 'r', encoding="utf-8") as f:
        ...
        lambda_code = lambda_code.replace('REDSHIFT_TOOLS_PLACEHOLDER', redshift_tools_json)
